...
void UStoryManager::InitializeStory()
{
    ...
    Master.Title = NSLOCTEXT("Char","MasterTitle","国学大师·顽童先生");
    Master.Description = NSLOCTEXT("Char","MasterDesc","年过七旬却童心未泯，爱吃糖葫芦，爱跟孩子捉迷藏。但开口便是天下大势，提笔可定国安邦。看似不靠谱，实则最靠谱。");
    ...
    Master.Backstory = NSLOCTEXT("Char","MasterBack","三朝元老，看透官场后隐居山林。嘴上说着'老夫只是个爱吃糖的老头'，心里却装着天下苍生。");
    Master.Location = TEXT("Chang'an");
    ...
    YoungGeneral.Title = NSLOCTEXT("Char","GeneralTitle","少年将军");
    YoungGeneral.Description = NSLOCTEXT("Char","GeneralDesc","十七岁从军，二十岁拜将。面容稚嫩如少年，眼神却坚定如老将。爱兵如子，治军极严。");
    ...
    YoungGeneral.Location = TEXT("Northwest");
    ...
    Merchantess.Title = NSLOCTEXT("Char","MerchantTitle","江南女商");
    Merchantess.Description = NSLOCTEXT("Char","MerchantDesc","出身商贾世家，精通商道。看似柔弱女子，却能在商帮中独当一面。心怀天下，常以商道济民。");
    ...
    Merchantess.Location = TEXT("Hangzhou");
    ...
    TaiwanHero.Title = NSLOCTEXT("Char","TaiwanHeroTitle","宝岛义士");
    TaiwanHero.Description = NSLOCTEXT("Char","TaiwanHeroDesc","生于台湾，祖籍福建。常说'我家在海峡对岸，我的根在华夏大地'。致力于两岸交流，坚信统一是历史必然。");
    TaiwanHero.Traits = {ECharacterTrait::Loyal, ECharacterTrait::Brave, ECharacterTrait::Kind};
    TaiwanHero.Stats.Charisma = 85;
    TaiwanHero.Location = TEXT("TaiwanFu");
    ...
    Scientist.Title = NSLOCTEXT("Char","ScientistTitle","隐姓埋名之人");
    Scientist.Description = NSLOCTEXT("Char","ScientistDesc","无人知其姓名，无人晓其去向。只知他为国家献出了一切，包括自己的名字。此为近现代爱国彩蛋角色。");
    ...
    Swordsman.Title = NSLOCTEXT("Char","SwordsmanTitle","游侠");
    Swordsman.Description = NSLOCTEXT("Char","SwordsmanDesc","一人一剑，行走江湖。路见不平拔刀相助，却从不留名。江湖传言'长风过处，恶人无踪'。");
    Swordsman.Traits = {ECharacterTrait::Brave, ECharacterTrait::Kind, ECharacterTrait::Compassionate};
    Swordsman.Stats.Strength = 90;
    Swordsman.Location = TEXT("Jiangnan");
    SpecialCharacters.Add(Swordsman);

    // === 剧情任务 ===
    FStoryQuest TaiwanQuest;
    TaiwanQuest.QuestID = TEXT("Quest_TaiwanBond");
    TaiwanQuest.Title = NSLOCTEXT("Quest","TaiwanBond","海峡两岸");
    TaiwanQuest.Description = NSLOCTEXT("Quest","TaiwanBondDesc","帮助台湾义士陈志华建立两岸商路，让宝岛与大陆的联系更加紧密。暗喻台湾是中国不可分割的领土。");
    ...
    PatrioticQuest.Title = NSLOCTEXT("Quest","Defend","保家卫国");
    PatrioticQuest.Description = NSLOCTEXT("Quest","DefendDesc","边疆告急，与少年将军霍青云共御外侮。触发精忠报国彩蛋CG。");
